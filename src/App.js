      ...
      <header className="masthead">
        <div className="container">
          <div className="masthead-subheading">
            Crafting Personal Experiences Into Comics
          </div>
          <div className="masthead-heading text-uppercase">Hey Comics</div>
          <a
        ...
        <div className="container">
          ...
          <div className="row text-center">
            <div className="col-md-4">
              ...
              <h4 className="service-heading">E-Comic</h4>
            ...
            <div className="col-md-4">
              ...
              <h4 className="service-heading">Hardbook-Comic</h4>
              <p className="text-muted">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima
                maxime quam architecto quo inventore harum ex magni, dicta
                impedit.
            ...
            <div className="col-md-4">
              ...
              <h4 className="service-heading">Wall-Comic</h4>
              <p className="text-muted">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima
                maxime quam architecto quo inventore harum ex magni, dicta
                impedit.
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              ...
              <h3 className="section-subheading text-muted">
                It's super simple to place an order for your loved ones!
              </h3>
            </div>
          </div>
          <div className="row">
                ...
                <li>
                  ...
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h4>Step 1</h4>
                      <h4 className="subheading">Share Your Story</h4>
                    </div>
